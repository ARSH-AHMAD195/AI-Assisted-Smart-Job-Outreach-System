...
class Indeed(Scraper):
    ...
    def scrape(self, scraper_input: ScraperInput) -> JobResponse:
        ...
        if self.scraper_input.extra_headers:
            self.headers.update(self.scraper_input.extra_headers)
        if self.scraper_input.extra_cookies:
            self.session.cookies.update(self.scraper_input.extra_cookies)
